export default {
  ...
  'runnerImport.nav': 'Runners',
  'runnerImport.runners.back': 'Back',
  'runnerImport.runners.title': 'Runners',
  'runnerImport.runners.description': 'Import Claude Code, Codex, or OpenCode history from each online runner machine. The list shows up to 500 sessions and may be truncated; messages are pulled from the runner in 100-message pages; the hub never scans its own disk.',
  'runnerImport.runners.refresh': 'Refresh',
  'runnerImport.runners.loading': 'Loading runners…',
  'runnerImport.runners.empty': 'No online runners. Start a runner, then import Claude Code, Codex, or OpenCode history from it.',
  'runnerImport.runners.emptyShort': 'No online runners',
  'runnerImport.runners.workspaceRoots': 'Workspace roots: {roots}',
  'runnerImport.runners.importHistory': 'Import history',
  'runnerImport.loadFailed.title': 'Failed to load runner sessions',
  'runnerImport.loadFailed.body': 'Unable to list sessions from runner',
  'runnerImport.failed.title': 'Failed to import runner sessions',
  'runnerImport.failed.body': 'Unable to import sessions from runner',
  'runnerImport.success.title': 'Runner sessions imported',
  'runnerImport.partial.title': 'Runner import partially completed',
  'runnerImport.success.body': 'Imported {sessions} session(s), {messages} new message(s), {failures} failed.',
  'runnerImport.dialog.title': 'Import runner sessions',
  'runnerImport.dialog.description': 'Import agent conversations from the selected online runner into Hapi. The list shows up to 500 sessions and may be truncated; only selected sessions are imported; messages are pulled from the runner in 100-message pages; the hub never scans its own disk.',
  'runnerImport.dialog.runner': 'Runner',
  'runnerImport.dialog.agent': 'Agent',
  'runnerImport.dialog.selectedCount': 'Selected {n}',
  'runnerImport.dialog.refresh': 'Refresh',
  'runnerImport.dialog.clear': 'Clear',
  'runnerImport.dialog.selectAll': 'Select all',
  'runnerImport.dialog.workdir': 'Working directory',
  'runnerImport.dialog.allDirectories': 'All directories',
  'runnerImport.dialog.loading': 'Loading runner sessions…',
  'runnerImport.dialog.refreshing': 'Refreshing runner session cache…',
  'runnerImport.dialog.refreshFailed': 'Refresh failed: {error}',
  'runnerImport.dialog.empty': 'No importable {agent} sessions found on this runner.',
  'runnerImport.dialog.emptyForWorkdir': 'No sessions in this working directory.',
  'runnerImport.dialog.pageStatus': 'Page {page} of {pages} · {total} sessions',
  'runnerImport.dialog.previousPage': 'Prev',
  'runnerImport.dialog.nextPage': 'Next',
  'runnerImport.dialog.pageInput': 'Page',
  'runnerImport.dialog.messageCount': '{n} msgs',
  'runnerImport.dialog.cwd': 'cwd',
  'runnerImport.dialog.failuresTitle': 'Import failures',
  'runnerImport.dialog.failuresMore': '+{n} more',
  'runnerImport.dialog.cancel': 'Cancel',
  'runnerImport.dialog.confirm': 'Import selected',
  'runnerImport.dialog.confirming': 'Importing…',
  ...
  'session.outline.pageLabel': 'Page',
  'session.outline.pageOption': 'Page {page}',
  'session.outline.pageStatus': 'Page {page} of {total}',
  'session.outline.currentWindow': 'Current window',
  'session.outline.pageBar': 'Page navigation',
  'session.outline.previousPage': 'Previous page',
  'session.outline.nextPage': 'Next page',
  'session.outline.goToPage': 'Go to page {page}',
