export default {
  ...
  'runnerImport.nav': 'Runner',
  'runnerImport.runners.back': '返回',
  'runnerImport.runners.title': 'Runners',
  'runnerImport.runners.description': '从在线 runner 机器导入 Claude Code、Codex 或 OpenCode 历史。列表最多显示 500 个会话，可能会被截断；消息按每页 100 条从 runner 拉取；hub 不扫描自己的磁盘。',
  'runnerImport.runners.refresh': '刷新',
  'runnerImport.runners.loading': '正在加载 runners…',
  'runnerImport.runners.empty': '没有在线 runner。先启动 runner，然后导入 Claude Code、Codex 或 OpenCode 历史。',
  'runnerImport.runners.emptyShort': '没有在线 runner',
  'runnerImport.runners.workspaceRoots': 'Workspace roots：{roots}',
  'runnerImport.runners.importHistory': '导入历史',
  'runnerImport.loadFailed.title': '加载 runner 会话失败',
  'runnerImport.loadFailed.body': '无法从 runner 列出会话',
  'runnerImport.failed.title': '导入 runner 会话失败',
  'runnerImport.failed.body': '无法从 runner 导入会话',
  'runnerImport.success.title': 'Runner 会话已导入',
  'runnerImport.partial.title': 'Runner 导入部分完成',
  'runnerImport.success.body': '已导入 {sessions} 个会话，{messages} 条新消息，{failures} 个失败。',
  'runnerImport.dialog.title': '导入 runner 会话',
  'runnerImport.dialog.description': '从选中的在线 runner 导入代理对话到 Hapi。列表最多显示 500 个会话，可能会被截断；只导入选中的会话；消息按每页 100 条从 runner 拉取；hub 不扫描自己的磁盘。',
  'runnerImport.dialog.runner': 'Runner',
  'runnerImport.dialog.agent': '代理',
  'runnerImport.dialog.selectedCount': '已选择 {n} 个',
  'runnerImport.dialog.refresh': '刷新',
  'runnerImport.dialog.clear': '清空',
  'runnerImport.dialog.selectAll': '全选',
  'runnerImport.dialog.workdir': '工作目录',
  'runnerImport.dialog.allDirectories': '全部目录',
  'runnerImport.dialog.loading': '正在加载 runner 会话…',
  'runnerImport.dialog.refreshing': '正在刷新 runner 会话缓存…',
  'runnerImport.dialog.refreshFailed': '刷新失败：{error}',
  'runnerImport.dialog.empty': '此 runner 上没有可导入的 {agent} 会话。',
  'runnerImport.dialog.emptyForWorkdir': '此工作目录下没有会话。',
  'runnerImport.dialog.pageStatus': '第 {page} / {pages} 页 · 共 {total} 个会话',
  'runnerImport.dialog.previousPage': '上一页',
  'runnerImport.dialog.nextPage': '下一页',
  'runnerImport.dialog.pageInput': '页码',
  'runnerImport.dialog.messageCount': '{n} 条',
  'runnerImport.dialog.cwd': 'cwd',
  'runnerImport.dialog.failuresTitle': '导入失败',
  'runnerImport.dialog.failuresMore': '另有 {n} 个',
  'runnerImport.dialog.cancel': '取消',
  'runnerImport.dialog.confirm': '导入选中项',
  'runnerImport.dialog.confirming': '导入中…',
  ...
  'session.outline.pageLabel': '页',
  'session.outline.pageOption': '第 {page} 页',
  'session.outline.pageStatus': '第 {page} / {total} 页',
  'session.outline.currentWindow': '当前窗口',
  'session.outline.pageBar': '页码导航',
  'session.outline.previousPage': '上一页',
  'session.outline.nextPage': '下一页',
  'session.outline.goToPage': '跳转到第 {page} 页',
